...
fun getFacebookFriends() = mutableListOf<SocialFriend>().apply {

    add(SocialFriend(0,
            "Madalina Loghin",
            "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQStarbhWvO65tb2lRjVuXaeMtYc-Yy6H0o3CIqmcva8MixvH3k",
            2))


    add(SocialFriend(1,
            "George Marian",
            "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQr-8Ub8YcIdWTpG8ntlYBFh2MjLtjY-14krlZV_4n8UTIVLTzI",
            3))

    add(SocialFriend(2,
            "George Bunea",
            "https://thewellspringfield.org/wp-content/uploads/2016/02/stephen-rippee-the-well-church-springfield-mo_web.jpg",
            12))

    add(SocialFriend(3,
            "Raluca Bodea",
            "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSNsJR6eLYg876E58tKsPlQoRTz7tX5ZFhZ6PgPj9Jsr4FqBIFi",
            5))

    add(SocialFriend(4,
            "Daniel Popovici",
            "https://ak8.picdn.net/shutterstock/videos/1583458/thumb/3.jpg",
            7))

    add(SocialFriend(5,
            "Radu Ene",
            "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQAPVGMEgzwNWXzN8KRscyBpJXo655IRzxUBrAobSf6dlwIUgf3",
            2))
...
fun getAllWishlistItems() = mutableListOf<Product>().apply {
    ...
    add(Product(0, "Nike, Pantofi din tricot pentru alergare FLEX 2017, Violet prafuit/Albastru azur",
            ...
            379.00,
            400.00,
            "It can get to you until Friday!"))
    ...
    add(Product(3, "Rucsac laptop Lenovo Classic by NAVA, 15.6\", Negru ",
            ...
            199.99,
            222.00,
            "It can get to you until Saturday!"))
    ...
    add(Product(6, "Televizor LED NEI, 109 cm, 43NE6000, 4K Ultra HD ",
            ...
            999.00,
            1500.00,
            "It can get to you until Monday!"))
    ...
    add(Product(9, "Mouse optic ASUS WT465, Wireless, USB, Alb ",
            ...
            99.90,
            120.00,
            "It can get to you until tomorrow!"))
